...
(function () {
  ...
  var NAV = [
    ...
    },
    {
      ...
      keywords: "פרויקט אפליקציה גיבוי מוניטור מחשבון שעון מזג אוויר סנכרון EXE בנייה מדריך",
      children: [
        {
          title: "גיבוי",
        ...
        {
          title: "מחשבון",
          href: "עמודים/בניית-מחשבון.html",
          keywords: "מחשבון HTML WebView חלונות דוגמה פתוחה",
        },
        {
          title: "שעון",
          href: "עמודים/בניית-שעון.html",
          keywords: "שעון דיגיטלי חלון מעוגל דוגמה פתוחה",
        },
        {
          title: "מזג־אוויר",
          href: "עמודים/בניית-מזג-אוויר.html",
          keywords: "מזג אוויר תחזית עיר צלסיוס Open-Meteo דוגמה פתוחה",
        },
      ],
    },
  ];
