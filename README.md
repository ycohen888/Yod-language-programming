...
| [`פרוייקט דוגמה/`](פרוייקט%20דוגמה/) | הסבר והורדה לתוכנות המוכנות (מוניטור, גיבוי) |
| [`מדריך שפת יוד/`](מדריך%20שפת%20יוד/) | מדריך HTML בעברית (תחביר + ספריות) |
| [`ads/`](ads/) | מערכת באנר הפרסום לתוכנות החופשיות (`ads.json` + באנרים) |
| [`docs/screenshots/`](docs/screenshots/) | צילומי מסך של העורך והשרת |
| [`CONTRIBUTING.md`](CONTRIBUTING.md) | איך לבנות, לבדוק ולפתוח PR |

> קוד המקור של התוכנות המוכנות אינו נכלל בריפו — הן מופצות כקובצי הרצה להורדה
> (ראו [תוכנות מוכנות](#תוכנות-מוכנות-חינם)).
...
פרוייקט דוגמה/       # הסבר + הורדה לתוכנות המוכנות (מוניטור, גיבוי)
מדריך שפת יוד/       # מדריך HTML
ads/                 # מערכת באנר הפרסום לתוכנות החופשיות
```
