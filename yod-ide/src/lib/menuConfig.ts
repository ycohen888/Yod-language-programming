...
export const APP_MENU: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: "separator" },
      { label: "כווץ בלוק", action: "code.fold", kb: "Ctrl+Alt+[" },
      { label: "הרחב בלוק", action: "code.unfold", kb: "Ctrl+Alt+]" },
      { label: "כווץ הכל", action: "code.foldAll" },
      { label: "הרחב הכל", action: "code.unfoldAll" },
      { type: "separator" },
  ...
  },
  {
    ...
    label: "הרצה",
    items: [
      { label: "הרץ תוכנית (מפרש)", action: "run.interpreter", kb: "F5" },
      { label: "הרץ קובץ נוכחי", action: "run.current" },
      { label: "הרץ תוכנית (מכונה/bytecode)", action: "run.vm", kb: "F6" },
      { type: "separator" },
      { label: "הרץ בטרמינל המשולב", action: "run.interpreter.terminal", kb: "Shift+F5" },
      { label: "הרץ קובץ נוכחי בטרמינל", action: "run.current.terminal" },
      { label: "עצור טרמינל (Ctrl+C)", action: "run.stop" },
      { type: "separator" },
      ...
      { type: "separator" },
      { label: "טרמינל — הצג/מקד", action: "view.terminal", kb: "Ctrl+`" },
      { label: "טרמינל חדש", action: "terminal.new" },
    ],
  },
  {
    id: "view",
    ...
    items: [
      ...
      { label: "השוואה מול הדיסק…", action: "view.diff" },
      { type: "separator" },
      ...
      { type: "separator" },
      { label: "הגדרות…", action: "view.settings", kb: "Ctrl+," },
